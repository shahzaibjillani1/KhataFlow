...
public class CategoryUpdateReqestValidator : AbstractValidator<CategoryUpdateRequest>
{
    public CategoryUpdateReqestValidator(IStringLocalizer<SharedResource> localizer)
    {
